...
<head>
    ...
    <title>Questões da Segunda Guerra Mundial</title>
</head>
...
<form action="5-Resultado-Segunda-Guerra.php" method="post">
    ...
    <div class="divpergunt" id="divpergunt1">
        ...
        <br>
        <input type="radio" name="quest1" class="question" id="q1_2"> O Japão buscou promover a prosperidade da Coreia, tutelando-a à semelhança do que os EUA faziam
        <br>
        <input type="radio" name="quest1" class="question" id="q1_3"> O povo japonês propôs cooperação aos Estados Unidos ao copiarem a Doutrina Monroe e proporem o desenvolvimento da Ásia
        <br>
        <input type="radio" name="quest1" class="question" id="q1_4"> A China aliou-se à Rússia contra o Japão, sendo que a doutrina Monroe previa a parceria entre os dois
        <br>
        <input type="radio" name="quest1" class="question" id="q1_5"> A Manchúria era território norte-americano e foi ocupado pelo Japão, originando a guerra entre os dois países
        <br>
    </div>
        <br>
    <div class="divpergunt" id="divpergunt2">
        ...
        <br>
        <input type="radio" class="question" name="quest2" id="q2_2"> A aliança entre a Inglaterra, a França e a Rússia poderia ter salvado a Tchecoslováquia
        <br>
        <input type="radio" class="question" name="quest2" id="q2_3"> O rompimento desse compromisso inspirou a política de "apaziguamento europeu"
        <br>
        <input type="radio" class="question" name="quest2" id="q2_4"> A política de Chamberlain de apaziguar o líder alemão era contrária à posição assumida pelas potências aliadas
        <br>
        <input type="radio" class="question" name="quest2" id="q2_5"> A forma que Chamberlain escolheu para lidar com o problema dos Sudetos deu origem a destruição da Tchecoslováquia
        <br>
    </div>
        <br>
    <div class="divpergunt" id="divpergunt3">
        ...
        <br>
        <input type="radio" class="question" name="quest3" id="q3_2"> Desencadeamento da Guerra Fria e de novas rivalidades entre nações
        <br>
        <input type="radio" class="question" name="quest3" id="q3_3"> Morte de milhões de soldados nos combates da Segunda Guerra Mundial
        <br>
        <input type="radio" class="question" name="quest3" id="q3_4"> Execução de judeus e eslavos presos em guetos e campos de concentração nazistas
        <br>
        <input type="radio" class="question" name="quest3" id="q3_5"> Lançamento de bombas atômicas em Hiroshima e Nagasaki pelas forças norte-americanas
        <br>
    </div>
        <br>
    <div class="divpergunt" id="divpergunt4">
        ...
        <br>
        <input type="radio" class="question" name="quest4" id="q4_2"> Capitalismo / devastação do ambiente natural
        <br>
        <input type="radio" class="question" name="quest4" id="q4_3"> Fascismo / adoção do determinismo biológico
        <br>
        <input type="radio" class="question" name="quest4" id="q4_4"> Socialismo / planificação da economia nacional
        <br>
        <input type="radio" class="question" name="quest4" id="q4_5"> Colonialismo / imposição da missão civilizatória
        <br>
    </div>
        <br>
    <div class="divpergunt" id="divpergunt5">
        ...
        <br>
        <input type="radio" class="question" name="quest5" id="q5_2"> Os regimes totalitários, na Segunda Guerra Mundial
         <br>
        <input type="radio" class="question" name="quest5" id="q5_3"> O poder soviético, durante a Guerra Fria
        <br>
        <input type="radio" class="question" name="quest5" id="q5_4"> O movimento comunista, na Guerra do Vietnã
        <br>
        <input type="radio" class="question" name="quest5" id="q5_5"> O terrorismo internacional, após 11 de setembro de 2001
        <br>
    </div>
        <br>
</form>
